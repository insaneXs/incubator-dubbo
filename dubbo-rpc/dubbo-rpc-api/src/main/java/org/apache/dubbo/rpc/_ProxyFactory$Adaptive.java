...
/**
 * @ClassName _ProxyFactory$Adaptive  Dubbo生成的ProxyFactory$Adaptive 为与原类区分类名前增加了_
 * @Description 根据URL参数 选择动态代理的方式 默认是javassist
 * @Author insaneXs
 * @Date 2020/9/21
 */
public class _ProxyFactory$Adaptive  implements org.apache.dubbo.rpc.ProxyFactory {
    @Override
